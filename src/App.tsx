                  ...
                  <div className="container">
                      <div className="row">
                          <div className="col-sm-8 col-md-7 py-4">
                              <h4>PT 2025</h4>
                              <p className="text-body-secondary">Enostavna FullStack aplikacija za galerijo filmov.</p>
                          </div>
                          <div className="col-sm-4 offset-md-1 py-4">
                              <h4>Meni</h4>
                              <ul className="list-unstyled">
                                  <li><a href="#" className="text-white">Domov</a></li>
                                  <li><a href="#" className="text-white">Žanri</a></li>
                                  <li><a href="#" className="text-white">Filmi</a></li>
                              </ul>
                          </div>
                      </div>
                  </div>
